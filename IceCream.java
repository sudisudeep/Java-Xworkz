class IceCream{
   ...
   public static int deleteFlavour(String deleteFlavour ){
	...
	public static String searchIceCreamByflavourName(String flavour){
		System.out.println("Invoking getIceCreamByflavourName");
		String fName = null;
		for(String name : flavourName){
			//"Chocolet".equals("Chocolate")
			if(name.equals(flavour)){
				fName = name;
				System.out.println("flavourName found" +fName);
